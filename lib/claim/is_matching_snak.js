...
const entityValueComparision = (snak, searchedValue) => snak.datavalue.value.id === searchedValue

const comparatorsByDatatype = {
  commonsMedia: simpleValueComparision,
  'external-id': simpleValueComparision,
  'geo-shape': simpleValueComparision,
  ...
  math: simpleValueComparision,
  'musical-notation': simpleValueComparision,
  ...
  'tabular-data': simpleValueComparision,
  ...
  'wikibase-form': entityValueComparision,
  'wikibase-item': entityValueComparision,
  'wikibase-lexeme': entityValueComparision,
  'wikibase-property': entityValueComparision,
  'wikibase-sense': entityValueComparision,
}
