...
module.exports = async (params, config, API) => {
  ...
  const currentEntityData = {
    ...
    summary: summary || generateCurrentEntitySummary(guid, originEntityId, originPropertyId, targetEntityId, targetPropertyId)
  }
  ...
  if (originEntityId === targetEntityId) {
    ...
    const targetEntityData = {
      ...
      id: targetEntityId,
      claims: movedClaims,
      summary: summary || generateTargetEntitySummary(guid, originEntityId, originPropertyId, targetEntityId, targetPropertyId)
    }
