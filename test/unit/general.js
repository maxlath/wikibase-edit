...
describe('general', () => {
  ...
  it('should have claim functions', done => {
    wdEdit(credentialConfig).claim.create.should.be.a.Function()
  ...
  it('should have qualifier functions', done => {
    wdEdit(credentialConfig).qualifier.set.should.be.a.Function()
  ...
  it('should have reference functions', done => {
    wdEdit(credentialConfig).reference.set.should.be.a.Function()
    // wdEdit(credentialConfig).qualifier.update.should.be.a.Function()
